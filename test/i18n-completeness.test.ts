...
describe("i18n translation completeness", () => {
  ...
  it("should not have orphaned keys (defined but not used)", () => {
    ...
    const KNOWN_UNUSED_KEYS = new Set([
      ...
      "eventEditor.categories",
      "eventEditor.categoriesPlaceholder",
      "eventEditor.sensitivity",
      "eventEditor.sensitivityNormal",
      "eventEditor.sensitivityPersonal",
      "eventEditor.sensitivityPrivate",
      "eventEditor.sensitivityConfidential",
      "eventEditor.attendeeName",
      "eventEditor.attendeeTypeResource",
      "eventEditor.noTeamsProvider",
      "eventEditor.saveBeforeAttachments",
      "eventEditor.removeAttachment",
      "eventEditor.addFile",
      "eventEditor.insertLink",
      "eventEditor.insertLinkPrompt",
      "eventEditor.editPlainText",
      "eventEditor.formattedNotesHint",
      "eventEditor.links",
      "eventEditor.attachmentsAndLinks",
      "eventEditor.optionalDetails",
